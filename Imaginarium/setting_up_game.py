...
def remove_used_source(source: sources.BaseSource) -> None:
    ...
    if not gameplay.GameCondition._game_started:
        GameCondition.used_sources.remove(source)
    else:
